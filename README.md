...
<p>Si vous souhaitez générer le rapport du code coverage des tests, il faut exécuter la commande suivante</p>
<pre><code>php bin/phpunit --coverage-html nomdudossier/test-coverage</code></pre>
